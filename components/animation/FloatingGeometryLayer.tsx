...
const SHAPES = [
  { type: "rect", x: "8%", y: "18%", w: 48, h: 48 },
  { type: "circle", cx: "88%", cy: "28%", r: 28 },
  { type: "rect", x: "78%", y: "62%", w: 64, h: 32 },
...
/**
 * Position with nested <svg x/y> — percentage values are valid there.
 * Do NOT use transform="translate(…%)"; SVG transform translate rejects %.
 */
function WireCube({ x, y }: { x: string; y: string }) {
  return (
    <svg x={x} y={y} width="32" height="50" overflow="visible" opacity="0.35">
      <path
